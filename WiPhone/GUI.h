...
protected:
  ...
  /* ⚠ The size must EXACTLY match the number of entries that survive the #ifdefs below, and
   * it cannot be omitted because this is a non-static member. Too many is a compile error;
